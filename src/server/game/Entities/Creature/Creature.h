...
class TC_GAME_API Creature : public Unit, public GridObject<Creature>, public MapObject
{
    public:
        ...
        bool IsSpawnedOnTransport() const { return m_creatureData && m_creatureData->GetMapId() != GetMapId(); }
        ...
        bool LoadFromDB(ObjectGuid::LowType spawnId, Map* map, bool addToMap = true, bool allowDuplicate = true);
        void SaveToDB();
                                                            // overriden in Pet
